...
<html lang="zh-cn">
  ...
  <body>
    <div class="content">
        <img id="pic1" width="90%" height="45%" src="${ctx }/common/images/image-58.png" />  
        <div style="z-index: 100;padding-top: -40px;position:absolute;font-weight: bold ;text-align: center;width: 90%">
           <p class="color2 font-size18">报警主机与微信绑定不成功</p>
           <p class="color2 font-size18">请重新再扫一次</p>
         </div> 
         <br><br>
   <p style="position: relative;margin-top: 60%;">
    <button type="button" id="saoBtn" class="btn btn-lg btn-info"> &nbsp;&nbsp;&nbsp;重试&nbsp;&nbsp;&nbsp;&nbsp;</button>
    </p>
